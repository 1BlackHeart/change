...
client.login('Mzk4NDQ0NjU4NjUwMjUxMjc0.DS-oBw.517oXAp0aGWilJtXNxcvpt8_8v0'); // هنا تضع توكان البوت الخاص بك
...
client.on('ready',  () => {
  console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'); 
  console.log('By : A B D U L L A H');
  console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
  console.log(`Logged in as  * [ " ${client.user.username} " ] servers! [ " ${client.guilds.size} " ]`);
  console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
  console.log('⚙            https://discord.gg/BySmcH3 |  سيرفرنا ');
  console.log('⚙            snapchat : xsa0');
...
client.on('ready', () => {
  ...
  .setDescription("معلومات عن الحــساب")
                                          .setFooter(`BlackHeart.`, 'https://a.top4top.net/p_734a070b1.jpg')
  .setColor("#9B59B6")
...
".support"
⚙            https://discord.gg/BySmcH3 |  رابط سيرفرنا 
⚙            snapchat : xsa0


© Made By :A B D U L L A H ™.
...
// -ping
  ...
  .addField('``سرعة أتصال الــبوت`` ' , `${Date.now() - message.createdTimestamp}` + ' ms`')
                 .setFooter(`© Made By :A B D U L L A H ™.`, 'https://a.top4top.net/p_734a070b1.jpg')
...
if (message.content === '-info') {
      message.author.send('🚬 | https://discord.gg/BySmcH3 | لـ أي استفسار').catch(e => console.log(e.stack));
